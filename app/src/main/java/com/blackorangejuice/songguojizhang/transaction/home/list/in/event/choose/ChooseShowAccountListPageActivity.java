...
public class ChooseShowAccountListPageActivity extends BasicActivity {
    ...
    public void refreshGlobleBlocks(boolean isFirst) {
        ...
        if (isFirst) {
            // 查询记账列表
            AccountItemMapper accountItemMapper = new AccountItemMapper(SongGuoDatabaseHelper.getSongGuoDatabaseHelper(ChooseShowAccountListPageActivity.this));
...
//            List<AccountItem> accountItems = accountItemMapper.selectDesc();
            ...
            // 组合Tag
            TagMapper tagMapper = new TagMapper(SongGuoDatabaseHelper.getSongGuoDatabaseHelper(ChooseShowAccountListPageActivity.this));
