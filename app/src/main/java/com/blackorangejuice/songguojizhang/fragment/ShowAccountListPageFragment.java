...
import com.blackorangejuice.songguojizhang.adapter.BlockRecycleViewAdapter;
...
public class ShowAccountListPageFragment extends BasicFragment {
    ...
    private void testInit() {
        // test
        AccountItemMapper accountItemMapper = new AccountItemMapper(SongGuoDatabaseHelper.getSongGuoDatabaseHelper(ShowAccountListPageFragment.this.getContext()));
...
//                            System.out.println("到顶了");
    ...
    public void refreshGlobleBlocks(boolean isFirst) {
        ...
        if (isFirst) {
            // 查询记账列表
            AccountItemMapper accountItemMapper = new AccountItemMapper(SongGuoDatabaseHelper.getSongGuoDatabaseHelper(getContext()));
...
//            List<AccountItem> accountItems = accountItemMapper.selectDesc();
            ...
            // 组合Tag
            TagMapper tagMapper = new TagMapper(SongGuoDatabaseHelper.getSongGuoDatabaseHelper(getContext()));
